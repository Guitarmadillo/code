...
void main_window::_main_window() {
  ...
  { Fl_Group* o = new Fl_Group(13, 11, 578, 482);
    ...
    { submit_button = new Fl_Return_Button(442, 444, 133, 37, "Calculate");
    ...
    { Fl_Box* o = new Fl_Box(13, 39, 573, 61, "label");
      o->box(FL_OXY_BUTTON_DOWN_BOX);
      o->labeltype(FL_NO_LABEL);
    } // Fl_Box* o
    { Fl_Box* o = new Fl_Box(13, 99, 573, 58, "label");
      o->box(FL_OXY_BUTTON_DOWN_BOX);
      o->color((Fl_Color)28);
      o->labeltype(FL_NO_LABEL);
    } // Fl_Box* o
    { Fl_Box* o = new Fl_Box(13, 183, 576, 61, "label");
      o->box(FL_OXY_BUTTON_DOWN_BOX);
      o->labeltype(FL_NO_LABEL);
    } // Fl_Box* o
    { Fl_Box* o = new Fl_Box(13, 243, 576, 58, "label");
      o->box(FL_OXY_BUTTON_DOWN_BOX);
      o->color((Fl_Color)28);
      o->labeltype(FL_NO_LABEL);
    } // Fl_Box* o
    { left_flex = new Fl_Flex(184, 40, 101, 117);
      { input_currency1size = new Fl_Input(184, 40, 101, 30, "Currency 1 position size:");
      ...
      { input_currency1rate = new Fl_Input(184, 70, 101, 29, "Currency 1 interest rate:");
      ...
      { input_currency3size = new Fl_Input(184, 99, 101, 29, "Currency 3 position size:");
      ...
      { input_currency3rate = new Fl_Input(184, 128, 101, 29, "Currency 3 interest rate:");
    ...
    { right_flex = new Fl_Flex(459, 40, 131, 118);
      { input_currency2size = new Fl_Input(459, 40, 131, 30, "Currency 2 position size:");
      ...
      { input_currency2rate = new Fl_Input(459, 70, 131, 30, "Currency 2 interest rate:");
      ...
      { input_tbillsize = new Fl_Input(459, 100, 131, 29, "Long T-Bill position size:");
        input_tbillsize->callback((Fl_Callback*)input_CB, (void*)(this));
        input_tbillsize->when(FL_WHEN_CHANGED);
      } // Fl_Input* input_tbillsize
      { input_tbillrate = new Fl_Input(459, 129, 131, 29, "T-Bill interest rate:");
        input_tbillrate->callback((Fl_Callback*)input_CB, (void*)(this));
        input_tbillrate->when(FL_WHEN_CHANGED);
      } // Fl_Input* input_tbillrate
      right_flex->end();
    } // Fl_Flex* right_flex
    { middle_left_flex = new Fl_Flex(185, 184, 101, 117);
      { input_currency1proceeds = new Fl_Input(185, 184, 101, 30, "Currency 1 proceeds:");
      ...
      { input_currency1proceedsrate = new Fl_Input(185, 214, 101, 29, "Proceeds Rate of Return:");
      ...
      { input_currency3proceeds = new Fl_Input(185, 243, 101, 29, "Currency 3 proceeds:");
      ...
      { input_currency3proceedsrate = new Fl_Input(185, 272, 101, 29, "Proceeds Rate of Return:");
    ...
    { middle_right_flex = new Fl_Flex(459, 184, 131, 118);
      { input_currency2proceeds = new Fl_Input(459, 184, 131, 30, "Currency 2 proceeds:");
      ...
      { input_currency2proceedsrate = new Fl_Input(459, 214, 131, 30, "Proceeds Rate of Return:");
      ...
      { input_tbillproceeds = new Fl_Input(459, 244, 131, 29, "Short T-Bill Proceeds:");
      ...
      { input_tbillproceedsrate = new Fl_Input(459, 273, 131, 29, "Proceeds Rate of Return:");
    ...
    { Fl_Box* o = new Fl_Box(34, 328, 485, 32, "label");
      o->box(FL_THIN_UP_FRAME);
      o->color((Fl_Color)40);
      o->selection_color((Fl_Color)78);
      o->labeltype(FL_NO_LABEL);
    ...
    { input_fxrate1 = new Fl_Input(345, 333, 99, 23, "Projected FX Rate Between Currency 1 && 2:");
    ...
    { invert_rate1 = new Fl_Button(449, 333, 64, 22, "Invert");
      invert_rate1->callback((Fl_Callback*)invert_CB, (void*)(this));
    } // Fl_Button* invert_rate1
    { Fl_Box* o = new Fl_Box(34, 362, 485, 32, "label");
      o->box(FL_THIN_UP_FRAME);
      o->color((Fl_Color)40);
      o->selection_color((Fl_Color)78);
      o->labeltype(FL_NO_LABEL);
    ...
    { input_fxrate2 = new Fl_Input(345, 367, 99, 23, "Projected FX Rate Between Currency 2 && 3:");
    ...
    { invert_rate2 = new Fl_Button(449, 367, 64, 22, "Invert");
      invert_rate2->callback((Fl_Callback*)invert_CB, (void*)(this));
    } // Fl_Button* invert_rate2
    { Fl_Box* o = new Fl_Box(34, 396, 485, 32, "label");
      o->box(FL_THIN_UP_FRAME);
      o->color((Fl_Color)40);
      o->selection_color((Fl_Color)78);
      o->labeltype(FL_NO_LABEL);
    ...
    { input_fxrate3 = new Fl_Input(345, 401, 99, 23, "Projected FX Rate Between Currency 1 && 3:");
    ...
    { invert_rate3 = new Fl_Button(449, 401, 64, 22, "Invert");
      invert_rate3->callback((Fl_Callback*)invert_CB, (void*)(this));
    } // Fl_Button* invert_rate3
    { account_positions_header = new Fl_Text_Display(186, 18, 238, 20);
      account_positions_header->box(FL_NO_BOX);
      account_positions_header->color(FL_BACKGROUND_COLOR);
      account_positions_header->labelfont(5);
      account_positions_header->labelsize(15);
      account_positions_header->scrollbar_width(0);
    } // Fl_Text_Display* account_positions_header
    { proceeds_positions_header = new Fl_Text_Display(186, 162, 238, 20);
      proceeds_positions_header->box(FL_NO_BOX);
      proceeds_positions_header->color(FL_BACKGROUND_COLOR);
      proceeds_positions_header->labelfont(5);
      proceeds_positions_header->labelsize(15);
      proceeds_positions_header->scrollbar_width(0);
    } // Fl_Text_Display* proceeds_positions_header
    { settings_header = new Fl_Text_Display(227, 307, 238, 20);
      settings_header->box(FL_NO_BOX);
      settings_header->color(FL_BACKGROUND_COLOR);
      settings_header->labelfont(5);
      settings_header->labelsize(15);
      settings_header->scrollbar_width(0);
    } // Fl_Text_Display* settings_header
    o->end();
  } // Fl_Group* o
  // SET HEADER TEXT 
  //
  Fl_Text_Buffer *h1buff = new Fl_Text_Buffer();
  this->account_positions_header->buffer(h1buff);

  // add the text to our buffer (to the box)
  h1buff->text("Account Positions (Long/Short)");

  Fl_Text_Buffer *h2buff = new Fl_Text_Buffer();
  this->proceeds_positions_header->buffer(h2buff);

  // add the text to our buffer (to the box)
  h2buff->text("Proceeds Positions (Long Only)");

  Fl_Text_Buffer *h3buff = new Fl_Text_Buffer();
  this->settings_header->buffer(h3buff);

  // add the text to our buffer (to the box)
  h3buff->text("FX Rate Settings");
  show();
  end();
}
...
void main_window::Calculate_CB(Fl_Widget*w, void* userdata) {
  // CALCULATE  RESULTS CALLBACK 
  //
  // grab pointer to main window object 
  main_window* instance = static_cast<main_window*>(userdata);

  // get x coord of main window 
  int x = instance->x();
  // get width of main window 
  int width = instance->w();

  int buffer = 10;
  // set the x coord of the new window to open to the right of the main window 
  int new_x = x + width + buffer;

  // Create an instance of new Result Window 
  if(instance->p_result_window == nullptr)
  {
  	instance->p_result_window = new results_window(new_x, 150, 471, 727, "Interest Calculator Results");
  	/* instance->p_result_window = new results_window(500, 100, 471, 727, "Interest Calculator Results"); */
  ...
  else
  {
  	...
  	instance->p_result_window->resize(new_x, 100, 471, 727);
...
void main_window::WinQuit_CB(Fl_Widget*w, void* userdata) {
  // MAIN WINDOW QUIT 
  //
  // grab pointer to main window object 
  main_window* instance = static_cast<main_window*>(userdata);
  ...
  /* // if result window is visible, hide both windows */ 
  if(instance->p_result_window != nullptr && instance->p_result_window->visible() == 1)
  {
  	instance->p_result_window->hide();
  }
  /* else */
  /* { */
  /* 	// only the main window is visible */
  /* 	instance->hide(); */
  /* } */
...
int main(int argc, char **argv) {
  ...
  main_window* mainwindow = new main_window(475,268,605,502,"VT - Position Interest Calculator");

  std::cout << "debug db path: " << dbPath <<std::endl;
  // open (ALREADY IN ABOVE CODE)
  sqlite3_open(dbPath, &db);
